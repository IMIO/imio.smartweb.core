...
class TestSubsite(ImioSmartwebTestCase):
    ...
    def test_viewlet_navigation(self):
        ...
        self.assertEqual(
            ...
            '<li class="nav_page1 nav-item nav-item-depth-1" role="presentation"><a href="http://nohost/plone/folder/page1" class="state-private nav-link" role="menuitem">Page 1</a></li><li class="nav_subfolder nav-item nav-item-depth-1" role="presentation"><a href="http://nohost/plone/folder/subfolder" class="state-private nav-link" role="menuitem">Subfolder</a></li>',
        )
